		...
		<article id="post-10" className="post-21 post type-post status-publish format-standard hentry category-uncategorized">
			<div className="flex flex-col justify-center items-center">
				<Card className="w-1/2 m-2">
					...
					<CardContent>
						<h3>California Agricultural Museum</h3>
						<a target="_blank" rel="noopener noreferrer" href="http://www.californiaagmuseum.org/">www.californiaagmuseum.org/</a>
					</CardContent>
				</Card>
				<Card className="w-1/2 m-2">
					<CardHeader>
				...
				<Card className="w-1/2 m-2">
					...
					<CardContent>
						...
						<a target="_blank" rel="noopener noreferrer" href="http://www.sacramentohistory.org/resources_timeline.html">Sacramento History Timeline</a>

						<h4>Internet Archive</h4>
						<p className="ml-8">a non-profit library of millions of free books, movies, software, music, and more.</p>
						<a target="_blank" rel="noopener noreferrer" href="https://archive.org">https://archive.org</a>
						...
						<a target="_blank" rel="noopener noreferrer" href="http://www.glbthistory.org/archives/">www.glbthistory.org/archives/</a>

						<h4>California State Archives</h4>
						<a target="_blank" rel="noopener noreferrer" href="http://www.sos.ca.gov/archives/archives_about.htm">www.sos.ca.gov/archives/archives_about.htm</a>
						...
						<a target="_blank" rel="noopener noreferrer" href="http://www.cityofsacramento.org/ccl/history/default.asp">www.cityofsacramento.org/ccl/history</a>

						<h3>County</h3>

						<h4>Yolo County Archives</h4>
						<a target="_blank" rel="noopener noreferrer" href="http://www.yolocounty.org/org/library/archives.htm">www.yolocounty.org/org/library/archives.htm</a>
						<h4>Sacramento City &amp; County Archives, extensive collections,</h4>
						<a target="_blank" rel="noopener noreferrer" href="http://www.centerforsacramentohistory.org">Center for Sacramento History </a>

						<h3>State</h3>

						<h4>California State Archives</h4>
						<p className="ml-8">a public research facility and they&nbsp;encourage you to come in person to do your research.</p>
						<a target="_blank" rel="noopener noreferrer" href="http://www.sos.ca.gov/archives/">www.sos.ca.gov/archives/</a>
				...
				<Card className="w-1/2 m-2">
					...
					<CardContent>
						...
						<a target="_blank" rel="noopener noreferrer" href="http://www.aerospaceca.org/">www.aerospaceca.org</a>
					</CardContent>
				</Card >
				...
				<Card className="w-1/2 m-2">
					...
					<CardContent>
						...
						<a target="_blank" rel="noopener noreferrer" href="http://www.valcomnews.com/?cat=6">www.valcomnews.com/?cat=6</a>
					</CardContent>
				</Card >
				<Card className="w-1/2 m-2">
					<CardHeader>
				...
				<Card className="w-1/2 m-2">
					...
					<CardContent>
						...
						<a target="_blank" rel="noopener noreferrer" href="http://coroner.saccounty.net/documents/NewHelvetiaBrochure.pdf">http://coroner.saccounty.net/documents/NewHelvetiaBrochure.pdf</a>

						<h4>List of Sacramento County Cemeteries</h4>
						<a target="_blank" rel="noopener noreferrer" href="http://coroner.saccounty.net/cemeteries.asp">http://coroner.saccounty.net/cemeteries.asp</a>

						<h4>Sacramento County Cemetery Advisory Commission</h4>
						<a target="_blank" rel="noopener noreferrer" href="http://coroner.saccounty.net/sccac.htm">http://coroner.saccounty.net/sccac.htm</a>

						<h4>Website for PDF of District Cemetery Brochure</h4>
						<a target="_blank" rel="noopener noreferrer" href="http://coroner.saccounty.net/documents/DistCemBro.pdf">http://coroner.saccounty.net/documents/DistCemBro.pdf</a>
						...
						<a target="_blank" rel="noopener noreferrer" href="http://www.gravestonestudies.org">www.gravestonestudies.org</a>
					</CardContent>
				</Card>
				<Card className="w-1/2 m-2">
					<CardHeader>
					...
					<CardContent>
						<h4>Locke Foundation</h4>
						<a target="_blank" rel="noopener noreferrer" href="http://www.locke-foundation.org/?np=true">www.locke-foundation.org/?np=true</a>

						<h4>Yee Fow Museum</h4>
						<a target="_blank" rel="noopener noreferrer" href="http://www.yeefowmuseum.org/learn.html">www.yeefowmuseum.org/learn.html</a>
					</CardContent >
				</Card >
				<Card className="w-1/2 m-2">
					<CardHeader>
				...
				<Card className="w-1/2 m-2">
					...
					<CardContent>
						...
						<a target="_blank" rel="noopener noreferrer" href="http://www.clrsearch.com/Sacramento-Demographics/CA/Population-by-Race-and-Ethnicity">www.clrsearch.com/Sacramento-Demographics/CA/Population-by-Race-and-Ethnicity</a>
					</CardContent>
				</Card >
			</div >
		</article >
